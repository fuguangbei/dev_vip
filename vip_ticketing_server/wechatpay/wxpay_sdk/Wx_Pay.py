# -*- coding:utf-8 -*-
import xmltodict
from wechatpay.wxpay_sdk.core.WxPayConfig import WxPayConfig
from wechatpay.wxpay_sdk.core.WxPayData import WxPayUnifiedOrder, WxPayOrderApp
from wechatpay.wxpay_sdk.WxPayNativePay import NativePay
from wechatpay.wxpay_sdk.WxPayAppPay import AppPay
from wechatpay.wxpay_sdk.WxPayJsApiPay import JsApiPay
from wechatpay.wxpay_sdk.core.WxPayException import WxPayException
from wechatpay.wxpay_sdk.notify import PayNotifyCallBack
__all__ = ['WxPayBasic']
...
class WxPayBasic(object):
    ...
    def unifiedorder2_get_code_url(self, out_trade_no, body, total_fee, notify_url, trade_type, product_id, attach='', \
        ...
        """
        result = self._unifiedorder_get_result(out_trade_no, body, total_fee, notify_url, trade_type, product_id,
                                               attach, \
                                               time_start, time_expire, goods_tag)
